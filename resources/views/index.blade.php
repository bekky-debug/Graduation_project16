            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white p-5">
                        ...
                        <h5 class="mb-3">Account-to-Account Transfer</h5>
                        <p>Easily send crypto between users instantly and securely.
                        </p>
                        <a href="{{route('wallet.transfer')}}">View Service <i class="fa fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4 wow fadeInUp">
                    <div class="currency-card">
                        ...
                        <h4 class="fw-bold">${{ number_format($btcPrice, 2) }}</h4>
                ...
                <div class="col-md-4 wow fadeInUp">
                    <div class="currency-card">
                        ...
                        <h4 class="fw-bold"> ${{ number_format($ethPrice, 2) }}</h4>
                ...
                <div class="col-md-4 wow fadeInUp">
                    <div class="currency-card">
                        ...
                        <h5 class="fw-bold text-primary">palestine coin</h5>
                        <p class="text-muted">palcoin</p>
                        <h4 class="fw-bold">$0.30</h4>
...
<!-- News Start -->
<div id="News" class="container-xxl bg-light py-5 my-5">
        ...
        <div id="newsCarousel" class="carousel slide mt-4" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="row g-0 align-items-center flex-column flex-md-row">
                        ...
                        <div class="col-md-6 d-flex flex-column justify-content-center p-4 ">
                            ...
                            <h4 class="fw-bold">Top Crypto Regulator Adrienne Harris Exits Key Financial Post After Four Years</h4>
                            ...
                            <a href="https://cryptonews.com/news/crypto-regulator-adrienne-harris-exits-nydfs-post-4-years/" class="btn btn-primary mt-3">Read More</a>
                        </div>
                        <!-- Image -->
                        <div class="col-md-6">
                            <img src="{{ asset('img/news1.jpg') }}" class="img-fluid  w-100" alt="Finance" style="border-radius: 25px;">
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="row g-0 align-items-center flex-column flex-md-row-reverse">
                        <!-- Text -->
                        <div class="col-md-6 d-flex flex-column justify-content-center p-4 ">
                            <p class="text-muted mb-1">April 10, 2024</p>
                            <h4 class="fw-bold">Q&A with Reeve Collins: Future-proofing stablecoins via STBL</h4>
                            ...
                            <a href="https://crypto.news/qa-with-reeve-collins-future-proofing-stablecoins-via-stbl-zero-knowledge-and-mintable-money/" class="btn btn-primary mt-3">Read More</a>
                        </div>
                        <!-- Image -->
                        <div class="col-md-6">
                            <img src="{{ asset('img/news2.webp') }}" class="img-fluid  w-100" alt="Ethereum"  style="border-radius: 25px;">
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="row g-0 align-items-center flex-column flex-md-row">
                        ...
                        <div class="col-md-6 d-flex flex-column justify-content-center p-4 ">
                            ...
                            <h4 class="fw-bold">Chinese National Pleads Guilty in $6.7B Crypto Seizure Case</h4>
                            ...
                            <a href="https://cryptonews.com/news/chinese-national-pleads-guilty-in-worlds-largest-6-7b-crypto-seizure-case/" class="btn btn-primary mt-3">Read More</a>
                        </div>
                        <!-- Image -->
                        <div class="col-md-6">
                            <img src="{{ asset('img/news3.jpg') }}" class="img-fluid  w-100" alt="Bitcoin"  style="border-radius: 25px;">
                        </div>
                    </div>
                </div>
